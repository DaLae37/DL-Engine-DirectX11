...
HRESULT Cube::CreatePipeline(ID3D11Device* d3dDevice) {
	...
	const std::vector<char>* vertexShaderBinary = ShaderManagerInstance->GetCompiledShader(L"Shaders/Cube_VS.hlsl", "main", "vs_5_0");
	...
	const std::vector<char>* pixelShaderBinary = ShaderManagerInstance->GetCompiledShader(L"Shaders/Cube_PS.hlsl", "main", "ps_5_0");
